...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Propriete::class, mappedBy: 'userid', orphanRemoval: true)]
    ...
    public function removePropriete(Propriete $propriete): static
    {
        if ($this->propriete->removeElement($propriete)) {
            ...
            if ($propriete->getUserid() === $this) {
                $propriete->setUserid(null);
            }
        }
